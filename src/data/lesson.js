export const lessons = [
    {
        ...
        "content": [
          "Ethics is about knowing what is right and wrong and choosing to do the right thing. It guides how people should behave and make decisions in everyday life.",
        ...
        "details": [
          ...
          "Different cultures and religions may have different ethical beliefs, but the goal is always to do what is right."
        ]
      },
    ...
    },
    {
      ...
      "details": [
        "The Utilitarian Approach - Ang isang kilos ay mabuti kung ito ay nagdadala ng pinakamalaking benepisyo sa pinakamaraming tao.",
        "The Egoistic Approach - Ang isang kilos ay tama kung ito ay nakabubuti sa sarili.",
        "The Common Good Approach - Isinasaalang-alang ang pangkalahatang kapakanan ng lahat sa paggawa ng desisyon (General will)."
      ]
    },
    {
      ...
      "details": [
        ...
        "Fairness and Justice Approach - Ang isang kilos ay dapat maging patas at makatarungan para sa lahat.",
        "The Divine Command Approach - Ang tama at mali ay batay sa mga kautusan ng Diyos."
      ]
    },
    {
    ...
    },
    {
      ...
      "details": [
        ...
        "James Rest and the Four-Stage Model - Apat na hakbang sa paggawa ng etikal na desisyon: (1) Pagkilala sa problema, (2) Pagsusuri ng tamang gawin, (3) Pagpapasya, at (4) Pagkilos.",
        "Donivan Bessinger and his Ethical Model - Nagpapakita ng balanse sa kita ng negosyo at etikal na responsibilidad."
      ]
    },
    {
      ...
      "details": [
        ...
        "Stage 3 - The Analysis: Maingat na suriin ang mga sangkot at mga maaaring maging epekto.",
        "Stage 4 - The Parade of Horrible: Ano ang magiging pananaw ng iba kung ang kilos ko ay nauunawaan o hindi nauunawaan?",
        "Stage 5 - Objective Measures: Ano ang mga naaangkop na salik tulad ng ekonomiya, etikal, legal, at propesyonal na dapat isaalang-alang?",
        "Stage 6 - The Decision: Pagkatapos ng pagsusuri, pumili ng tamang aksyon.",
        "Stage 7 - Assess and Evaluate: Ipatupad ang plano at suriin kung epektibo ang naging solusyon.",
        "Stage 8 - Learn: Pagsama-samahin ang mga natutunan at gamitin ito sa hinaharap."
      ]
    },
    {
      "title": "Ethical Principles for Business Executives",
      "content": [
    ...
    {
      "title": "Benefits of Good Ethical Behavior",
      "content": [
