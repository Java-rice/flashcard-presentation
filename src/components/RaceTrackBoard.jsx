...
const RaceTrackBoard = ({ players, currentPlayerIndex, winScore, onSelectPlayer }) => {
  return (
    <div className="w-full md:w-1/3 p-6 bg-[#E0B089] dark:bg-[#5D4037] rounded-lg shadow-lg">
      ...
      {/* Player Selection */}
      <div className="mb-6">
        <h3 className="text-lg font-semibold mb-3 text-center">Select Player</h3>
          ...
          {players.map((player, index) => {
            ...
            return (
              <motion.div
                ...
                initial={{ bottom: 0 }}
                animate={{
                  bottom: `calc(${progressPercentage}% - ${progressPercentage > 0 ? 10 : 0}px)`,
              ...
              >
                <div
                  ...
                  style={{ backgroundColor: getPlayerColor(index), fontSize: "0.75rem" }}
                >
                  {player.name[0]}
                </div>
